            ...
            <div class=\"collapse navbar-collapse\" id=\"navPrincipal\">
                <ul class=\"navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center gap-lg-1\">
                    ...
                    <?php if (!empty($_SESSION['usuario_id']) || !empty($_SESSION['admin_id'])): ?>
                        <?php
                        // CORRECCIÓN: Unificamos el rol comprobando 'admin' o 'administrador' de forma segura
                        $esAdminNav = !empty($_SESSION['admin_id']) || (($_SESSION['usuario_tipo'] ?? '') === 'admin') || (($_SESSION['usuario_tipo'] ?? '') === 'administrador');
                        
                        // CORRECCIÓN: Rutas absolutas con '/' por delante para que nunca se queden atrapadas en /controlador/
